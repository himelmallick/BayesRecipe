...
It is satisfactory to observe that for this benchmark dataset the samples traverse the posterior space very fast confirming that the sampler has good mixing property.
...
If you use `BayesRecipe` in your work, please cite the following:

Mallick H, Alhamzawi R, Paul E, Svetnik V (2021). [The Reciprocal Bayesian LASSO](https://onlinelibrary.wiley.com/doi/abs/10.1002/sim.9098). *Statistics in Medicine*, Upcoming.
